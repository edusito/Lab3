...
<body>
    ...
    <div class="wrapper">
                            ...
                            <div class="nav-icon-item">
                                ...
                                <div class="cart-menu-bar">
                                    <ul class="cart-menu-list">
                                        <li>
                                            <a class="product-img">
                                                <img src="Asset/img/product/02.jpg" alt="fashion">
                                            </a>
            ...
            <div class="flexslider fullscreen-carousel hero-slider-1 ">
                <ul class="slides">
                    ...
                    <li data-slide="light-slide">
                        <div class="slide-bg-image overlay-light parallax parallax-section1" data-background-img="Asset/img/full/11.jpg">
                    ...
                    <li data-slide="dark-slide">
                        <div class="slide-bg-image overlay-dark dark-bg parallax parallax-section1" data-background-img="Asset/img/full/20.jpg">
                            <div class="js-Slide-fullscreen-height container">
                                <div class="intro-content">
                                    <div class="intro-content-inner">
                    ...
                    <!--Slide-->
                    <li data-slide="light-slide">
                        <div class="slide-bg-image overlay-light parallax parallax-section1" data-background-img="Asset/img/full/02.jpg">
                            <div class="js-Slide-fullscreen-height container">
                                <div class="intro-content">
                                    <div class="intro-content-inner">
                    ...
                    <!--Slide-->
                    <li data-slide="dark-slide">
                        <div class="slide-bg-image overlay-dark dark-bg parallax parallax-section1" data-background-img="Asset/img/full/18.jpg">
                            <div class="js-Slide-fullscreen-height container">
                                <div class="intro-content">
                                    <div class="intro-content-inner">
        ...
        <!-- Counter Section -->
        <se/ction id="counter" class="overlay-dark80 light-color ptb-80" style="background-image: url('Asset/img/full/23.jpg');" data-stellar-background-ratio="0.5">
                ...
                <div class="row">
                    <div class="col container-grid nf-col-4">
                        ...
                        <div class="nf-item branding design coffee">
                            <div class="item-box">
                                <a class="cbox-gallary1" href="Asset/img/portfolio/1.jpg" title="Consequat massa quis">
                                    <img class="item-container" src="Asset/img/portfolio/1.jpg" alt="1" />
                                    <div class="item-mask">
                        ...
                        <div class="nf-item photo">
                            <div class="item-box">
                                <a class="cbox-gallary1" href="Asset/img/portfolio/2.jpg" title="Vivamus elementum semper">
                                    <img class="item-container" src="Asset/img/portfolio/2.jpg" alt="2" />
                                    <div class="item-mask">
                                        <div class="item-caption">
                        ...
                        <div class="nf-item branding design coffee">
                            <div class="item-box">
                                <a class="cbox-gallary1" href="Asset/img/portfolio/3.jpg" title="Quisque rutrum">
                                    <img class="item-container" src="Asset/img/portfolio/3.jpg" alt="4" />
                                    <div class="item-mask">
                                        <div class="item-caption">
                        ...
                        <div class="nf-item branding design">
                            <div class="item-box">
                                <a class="cbox-gallary1" href="Asset/img/portfolio/4.jpg" title="Tellus eget condimentum">
                                    <img class="item-container" src="Asset/img/portfolio/4.jpg" alt="4" />
                                    <div class="item-mask">
                                        <div class="item-caption">
                        ...
                        <div class="nf-item branding design">
                            <div class="item-box">
                                <a class="cbox-gallary1" href="Asset/img/portfolio/5.jpg" title="Nullam quis ant">
                                    <img class="item-container" src="Asset/img/portfolio/5.jpg" alt="5" />
                                    <div class="item-mask">
                                        <div class="item-caption">
                        ...
                        <div class="nf-item photo">
                            <div class="item-box">
                                <a class="cbox-gallary1" href="Asset/img/portfolio/6.jpg" title="Sed fringilla mauris">
                                    <img class="item-container" src="Asset/img/portfolio/6.jpg" alt="6" />
                                    <div class="item-mask">
                                        <div class="item-caption">
                        ...
                        <div class="nf-item design">
                            <div class="item-box">
                                <a class="cbox-gallary1" href="Asset/img/portfolio/7.jpg" title="Augue velit cursus">
                                    <img class="item-container" src="Asset/img/portfolio/7.jpg" alt="7" />
                                    <div class="item-mask">
                                        <div class="item-caption">
                        ...
                        <div class="nf-item coffee">
                            <div class="item-box">
                                <a class="cbox-gallary1" href="Asset/img/portfolio/8.jpg" title="Donec sodales sagittis">
                                    <img class="item-container" src="Asset/img/portfolio/8.jpg" alt="8" />
                                    <div class="item-mask">
                                        <div class="item-caption">
            ...
            <div class="owl-carousel content-carousel content-slider">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 mb-sm-30">
                                <img src="Asset/img/moc-1.png" alt="" />
                            </div>
                ...
                <div class="item">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 mb-sm-30">
                                <img src="Asset/img/moc-2.png" alt="" />
                            </div>
                            <div class="col-md-5 offset-md-1">
        ...
        <!-- Testimonials -->
        <section id="testimonial" class="overlay-dark80 dark-bg ptb ptb-sm-80" style="background-image: url('Asset/img/full/22.jpg');" data-stellar-background-ratio="0.5">
            <div class="container">
        ...
        <section id="features" class="ptb ptb-sm-80">
            <div class="container text-center">
                ...
                <div class="spacer-60"></div>
                <div class="row">
                    <div class="wow fadeInLeft col-md-4 d-flex align-content-center flex-wrap">
                    ...
                    <div class="wow fadeIn col-md-4 hidden-sm hidden-xs text-center">
                        <img src="Asset/img/moc-3.png" />
                    </div>
                    <div class="wow fadeInRight col-md-4 d-flex align-content-center flex-wrap">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-sm-30">
                        <div class="blog-post">
                            <div class="post-media">
                                <video class="video" style="width: 100%;" width="" height="" preload="auto" poster="Asset/media/echo-hereweare.jpg" controls="controls">
                                    <!-- MP4 source must come first for iOS -->
                                    <source type="video/mp4" src="Asset/media/video1.mp4" />
                                    <!-- WebM for Firefox 4 and Opera -->
                                    <source type="video/webm" src="Asset/media/video1.webm" />
                                    <!-- OGG for Firefox 3 -->
                                    <source type="video/ogg" src="Asset/media/video1.ogv" />
                                </video>
                            </div>
                        ...
                        <div class="blog-post">
                            <div class="post-media">
                                <div class="owl-carousel item1-carousel nf-carousel-theme">
                                    <div class="item">
                                        <img src="Asset/img/full/26.jpg" alt="" />
                                    </div>
                                    <div class="item">
                                        <img src="Asset/img/full/04.jpg" alt="" />
                                    </div>
                                    <div class="item">
                                        <img src="Asset/img/full/27.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-sm-30">
                        <div class="blog-post">
                            <div class="post-media">
                                <img class="item-container" src="Asset/img/full/20.jpg" alt="" />
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="item-box">
                            ...
                            <div class="shop-item">
                                <div class="item-img">
                                    <img src="Asset/img/product/07.jpg" />
                                </div>
                                <div class="item-mask">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="item-box">
                            ...
                            <div class="shop-item">
                                <div class="item-img">
                                    <img src="Asset/img/product/01.jpg" />
                                </div>
                                <div class="item-mask">
                                    <div class="item-mask-detail">
                                        <div class="item-mask-detail-ele">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="item-box">
                            ...
                            <div class="shop-item">
                                <div class="item-img">
                                    <img src="Asset/img/product/02.jpg" />
                                </div>
                                <div class="item-mask">
                                    <div class="item-mask-detail">
                                        <div class="item-mask-detail-ele">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="item-box">
                            ...
                            <div class="shop-item">
                                <div class="item-img">
                                    <img src="Asset/img/product/03.jpg" />
                                </div>
                                <div class="item-mask">
                                    <div class="item-mask-detail">
                                        <div class="item-mask-detail-ele">
                ...
                <div class="owl-carousel client-carousel nf-carousel-theme ">
                    <div class="item">
                        <div class="client-logo">
                            <img src="Asset/img/logos/01.png" alt="" />
                        </div>
                    </div>
                    <div class="item">
                        <div class="client-logo">
                            <img src="Asset/img/logos/02.png" alt="" />
                        </div>
                    </div>
                    <div class="item">
                        <div class="client-logo">
                            <img src="Asset/img/logos/03.png" alt="" />
                        </div>
                    </div>
                    <div class="item">
                        <div class="client-logo">
                            <img src="Asset/img/logos/04.png" alt="" />
                        </div>
                    </div>
                    <div class="item">
                        <div class="client-logo">
                            <img src="Asset/img/logos/05.png" alt="" />
                        </div>
                    </div>
                    <div class="item">
                        <div class="client-logo">
                            <img src="Asset/img/logos/06.png" alt="" />
                        </div>
                    </div>
                    <div class="item">
                        <div class="client-logo">
                            <img src="Asset/img/logos/08.png" alt="" />
                        </div>
                    </div>
                    <div class="item">
                        <div class="client-logo">
