                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 text-center">
                        <div class="pie-chart opacity-9-5">
                            <div class="chart font-alt text-white" data-percent="0" data-percent-update="83" data-bar-color="#ff1a56" data-track-color="#ffffff">
                    ...
                    <div class="col-md-6 col-lg-3 mt-5 mt-md-0 text-center">
                        <div class="pie-chart opacity-9-5">
                            <div class="chart font-alt text-white" data-percent="0" data-percent-update="51" data-bar-color="#ff1a56" data-track-color="#ffffff">
                                <span class="percent font-alt font-w-600 title-extra-large-2">0%</span>
                            </div>
                            <!-- //.chart -->
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 mt-5 mt-lg-0 text-center">
                        <div class="pie-chart opacity-9-5">
                            <div class="chart font-alt text-white" data-percent="0" data-percent-update="64" data-bar-color="#ff1a56" data-track-color="#ffffff">
                                <span class="percent font-alt font-w-600 title-extra-large-2">0%</span>
                            </div>
                            <!-- //.chart -->
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 mt-5 mt-lg-0 text-center">
                        <div class="pie-chart opacity-9-5">
                            <div class="chart font-alt text-white" data-percent="0" data-percent-update="90" data-bar-color="#ff1a56" data-track-color="#ffffff">
                                <span class="percent font-alt font-w-600 title-extra-large-2">0%</span>
                            </div>
                            <!-- //.chart -->
                        </div>
